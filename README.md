...
[![Build Status](https://travis-ci.org/lonemadmax/freeciv-web.svg?branch=movingborders)](https://travis-ci.org/lonemadmax/freeciv-web)
...
* [Freeciv](freeciv) - the Freeciv C server, implemented in C.
