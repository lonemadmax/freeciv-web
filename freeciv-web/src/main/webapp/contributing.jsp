...
.accounting tr>td:last-child {
 text-align: right;
	...
	<div class="container">
		...
		<p>Last updated: 2018-11-14</p>
		<h4>Lifetime total</h4>
		<table class="accounting">
			<tr><th scope="row">Future expected payments</th><td>-370,11</td></tr>
			<tr><th scope="row">Past real payments</th><td>-41,76</td></tr>
		...
		<table class="accounting">
		<tbody>
			<tr><td></td><th scope="row">Future expected payments</th><td>-28,47</td></tr>
			<tr><td></td><th scope="row">Past real payments</th><td>-41,76</td></tr>
			<tr><td></td><th scope="row">Donations</th><td>0,00</td></tr>
		</tbody>
		<tbody>
