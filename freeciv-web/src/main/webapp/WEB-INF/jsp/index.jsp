...
<body>
	<div class="container">
		...
		<div>
			...
			<p>So it seems we finally have one server for everybody. Check out <a href="https://www.freecivweb.com/">freecivweb.com</a>. If you want to move your games there, <a href="mailto:antiswen@yahoo.es">send me a message</a> from you registered mail address detailing your username, whether you want to remove your account from here and, if you already have an account in the other server, what are the username and mail address there.</p>
		...
		<div id="game-launcher" class="row">
				...
				<div class="col-md-6">
					<div class="game-type">
						...
						<c:if test="${default_lang}">
							<div class="features">
								Build your map from an image.
							</div>
						</c:if>
						<a href="/freeciv-earth/map-from-image.jsp" class="btn"><i class="fa fa-globe"></i> <fmt:message key="index-game-launcher-real-earth"/></a>
					</div>
				</div>
				<div class="col-md-6">
					<div class="game-type">
